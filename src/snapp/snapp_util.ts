import { isReady, Mina, PrivateKey, Field, UInt64, Party, PublicKey } from 'snarkyjs';
import { ZKPass } from './zkpass';
import { SignatureWithName, SignatureWithSigner } from './contract_type';
import { testDb } from './mock';
import { packBytes } from '../lib/utils/encode';
...
async function deposit(senderPrivateKey: PrivateKey, depositName: string, depositAmount: number) {
  console.log('deposit');
